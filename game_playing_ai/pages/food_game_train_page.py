...
class FoodGameTrainPage:
    ...
    def make_page(self):
        ...
        # num drl agents
        self.num_drl_agents_label = pygame_gui.elements.UILabel(relative_rect=pygame.Rect((525,50), (150, 30)), 
                                                            container=self.train_config_panel,
                                                            text='Num DRL Agents', manager=self.manager)
        self.num_drl_agents_text_entry = pygame_gui.elements.UITextEntryLine(relative_rect=pygame.Rect((675, 50), (100, 30)),
                                                                    container=self.train_config_panel,
                                                                    initial_text="2",
                                                                    manager=self.manager)
        ...
        self.num_preprogrammed_agents_label = pygame_gui.elements.UILabel(relative_rect=pygame.Rect((525,100), (150, 30)), 
                                                            container=self.train_config_panel,
                                                            text='Num Preprog Agents', manager=self.manager)
        self.num_preprogrammed_agents_text_entry = pygame_gui.elements.UITextEntryLine(relative_rect=pygame.Rect((675, 100), (100, 30)),
                                                                    container=self.train_config_panel,
                                                                    initial_text="2",
                                                                    manager=self.manager)
        ...
        # obstacles
        self.obstacles_label = pygame_gui.elements.UILabel(relative_rect=pygame.Rect((525,150), (150, 30)), 
                                                            container=self.train_config_panel,
                                                            text='Obstacles', manager=self.manager)
        self.obstacles_drop_down_menu = pygame_gui.elements.UIDropDownMenu(relative_rect=pygame.Rect((675, 150), (100, 30)),
                                                                    container=self.train_config_panel,
                                                                    manager=self.manager,
                                                                    options_list=["True", "False"],
        ...
        # Combat
        self.combat_label = pygame_gui.elements.UILabel(relative_rect=pygame.Rect((525,200), (150, 30)), 
                                                            container=self.train_config_panel,
                                                            text='Combat', manager=self.manager)
        self.combat_drop_down_menu = pygame_gui.elements.UIDropDownMenu(relative_rect=pygame.Rect((675, 200), (100, 30)),
                                                                    container=self.train_config_panel,
                                                                    manager=self.manager,
                                                                    options_list=["True", "False"],
                                                                    starting_option="False")
